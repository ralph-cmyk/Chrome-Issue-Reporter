...
if (!extensionId || !version || !downloadUrl) {
  console.error(
    "Usage: node scripts/update-manifest.js <extension-id> <version> <download-url> [output-path]",
  );
  console.error(
    "Example: node scripts/update-manifest.js abcdefghijklmnopqrstuvwxyz123456 21.0.0 https://example.com/extensions/extension-v21.0.0.zip update.xml",
  );
  process.exit(1);
}
